...
python3 -m client.tcp_client --node-id node-04 --mode high-latency --interval 3.0
\end{lstlisting}
...
\hline
\texttt{node-03} & \texttt{high-ram} & RAM alta. \\
\hline
\texttt{node-04} & \texttt{high-latency} & Latencia alta. \\
\hline
